  ...
  function createSnowflake() {
    ...
    snowflake.style.animationDuration = Math.random() * 3 + 2 + 's'; // Thay đổi thời gian rơi
    document.body.appendChild(snowflake);
    setTimeout(() => {
        snowflake.remove();
    }, 5000); // Thời gian tồn tại của tuyết
}

setInterval(createSnowflake, 300); // Tạo tuyết mỗi 300ms
